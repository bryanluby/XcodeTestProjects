//
//  BJLPropertiesDebugView.m
//  QuickLookDebugging
//
//  Created by Bryan Luby on 4/27/14.
//  Copyright (c) 2014 Bryan Luby. All rights reserved.
//

#import "BJLPropertiesDebugView.h"
#import <objc/runtime.h>

@implementation BJLPropertiesDebugView

+ (instancetype)debugQuickLookViewWithObject:(id)modelObject
{
    CGRect frame = CGRectMake(0, 0, 600, 600);
    BJLPropertiesDebugView *debugView = [[self alloc] initWithFrame:frame];
    
    UITextView *textView = [[UITextView alloc] initWithFrame:frame];
    textView.font = [UIFont boldSystemFontOfSize:20];
    textView.text = [self debugViewTextFromModelObject:modelObject];
